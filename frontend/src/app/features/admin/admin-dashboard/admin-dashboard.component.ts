      ...
      <main class="flex-1 bg-gradient-to-b from-spotify-dark to-black overflow-y-auto">
        <div class="p-8">
          ...
          <div class="mb-8">
            ...
            <p class="text-spotify-gray">Manage your music streaming platform</p>
          </div>
          ...
          <div *ngIf="activeTab === 'Songs'">
            ...
            <div class="bg-spotify-dark p-6 rounded-lg mb-8">
              ...
              <form (ngSubmit)="addSong()" #songForm="ngForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label class="block text-spotify-gray mb-2">Audio File</label>
                    <input
                      type="file"
                ...
                <button type="submit" [disabled]="!songForm.form.valid" class="btn-primary">
                  Add Song
                </button>
              </form>
            </div>
            ...
            <div class="bg-spotify-dark p-6 rounded-lg">
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-left">
                  ...
                  <tbody>
                    <tr *ngFor="let song of songs" class="border-b border-gray-800">
                      ...
                      <td class="py-3 text-spotify-gray">{{ song.playCount }}</td>
                      <td class="py-3">
                        <button 
            ...
            <div class="bg-spotify-dark p-6 rounded-lg mb-8">
              ...
              <form (ngSubmit)="addAlbum()" #albumForm="ngForm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <label class="block text-spotify-gray mb-2">Cover Image</label>
                    <input
                      type="file"
                ...
                <button type="submit" [disabled]="!albumForm.form.valid" class="btn-primary">
                  Add Album
                </button>
              </form>
            </div>
            ...
            <div class="bg-spotify-dark p-6 rounded-lg">
              ...
              <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <div *ngFor="let album of albums" class="relative group">
                  ...
                  >
                  <h4 class="text-white font-medium truncate">{{ album.title }}</h4>
                  <p class="text-spotify-gray text-sm truncate">{{ album.artist }}</p>
                  <button 
            ...
            <div class="bg-spotify-dark p-6 rounded-lg">
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-left">
                  ...
                  <tbody>
                    <tr *ngFor="let user of users" class="border-b border-gray-800">
                      ...
                      <td class="py-3 text-spotify-gray">{{ user.createdAt | date:'short' }}</td>
...
export class AdminDashboardComponent implements OnInit {
  ...
  genres = ['Pop', 'Rock', 'Hip-Hop', 'Electronic', 'Jazz', 'Classical', 'Country', 'R&B', 'Other'];
